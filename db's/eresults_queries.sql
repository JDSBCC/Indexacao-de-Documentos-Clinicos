...
select d.documento_id, f.*, dl.doente, ge.*, c.*, s.sigla, s.descricao, ec.descricao as estado_civil from er_ficheiro f
...
where f.elemento_id>13706193 AND f.elemento_id<13716193;
