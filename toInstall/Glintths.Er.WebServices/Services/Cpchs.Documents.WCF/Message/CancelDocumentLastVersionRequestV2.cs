...
{
    /// <summary>
    /// Service Contract Class - CancelDocumentLastVersionRequestV2
    /// </summary>
    [WCF::MessageContract(WrapperName = "CancelDocumentLastVersionRequestV2", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)]
