...
{
	/// <summary>
	/// Service Contract Class - GetPatientDocumentsResponse
	/// </summary>
    [WCF::MessageContract(WrapperName = "GetPatientDocumentsResponse", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)] 
