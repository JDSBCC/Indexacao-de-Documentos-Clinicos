...
{
	/// <summary>
	/// Service Contract Class - CancelDocumentLastVersionResponse
	/// </summary>
    [WCF::MessageContract(WrapperName = "CancelDocumentLastVersionResponse", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)] 
