...
{
	/// <summary>
	/// Service Contract Class - CancelDocumentPermanentlyResponse
	/// </summary>
    [WCF::MessageContract(WrapperName = "CancelDocumentPermanentlyResponse", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)] 
