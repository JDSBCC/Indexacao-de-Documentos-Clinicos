...
{
	/// <summary>
	/// Service Contract Class - CancelDocumentPermanentlyRequest
	/// </summary>
    [WCF::MessageContract(WrapperName = "CancelDocumentPermanentlyRequest", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)] 
