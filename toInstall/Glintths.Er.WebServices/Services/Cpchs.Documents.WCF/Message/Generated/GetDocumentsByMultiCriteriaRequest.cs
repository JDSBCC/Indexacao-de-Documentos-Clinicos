...
{
	/// <summary>
	/// Service Contract Class - GetDocumentsByMultiCriteriaRequest
	/// </summary>
    [WCF::MessageContract(WrapperName = "GetDocumentsByMultiCriteriaRequest", WrapperNamespace = "urn:Cpchs.Documents", IsWrapped = true)] 
