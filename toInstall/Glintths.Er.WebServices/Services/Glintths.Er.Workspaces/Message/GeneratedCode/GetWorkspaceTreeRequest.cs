...
{
	/// <summary>
	/// Service Contract Class - GetWorkspaceTreeRequest
	/// </summary>
	[WCF::MessageContract(WrapperName = "GetWorkspaceTreeRequest", WrapperNamespace = "http://Glintths.Er.Services.Model/2011/Glintths")] 
	public partial class GetWorkspaceTreeRequest
	{
		...
		[WCF::MessageBodyMember(Namespace = "http://Glintths.Er.Services.Model/2011/Glintths", Name = "User")]
		public string User
		{
			get { return user; }
			set { user = value; }
