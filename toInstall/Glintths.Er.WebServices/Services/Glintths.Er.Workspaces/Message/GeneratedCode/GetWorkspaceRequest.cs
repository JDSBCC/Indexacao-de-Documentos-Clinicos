...
{
	/// <summary>
	/// Service Contract Class - GetWorkspaceRequest
	/// </summary>
	[WCF::MessageContract(WrapperName = "GetWorkspaceRequest", WrapperNamespace = "http://Glintths.Er.Services.Model/2011/Glintths")] 
