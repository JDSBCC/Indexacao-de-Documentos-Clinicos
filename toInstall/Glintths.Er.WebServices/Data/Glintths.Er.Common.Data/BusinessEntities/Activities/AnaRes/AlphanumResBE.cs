...
namespace Cpchs.Eresults.Common.WCF.BusinessEntities
{
    ...
    /// </summary>
    [DataContract(Name = "AlphanumRes", Namespace = "http://glintt.com/types")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1705:LongAcronymsShouldBePascalCased"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores"), Serializable]
    public class AlphanumRes : AlphanumRes_GEN
    {
        ...
        /// Initialize an new empty AlphanumRes object.
        /// </summary>
        public AlphanumRes(IDataReader reader, string companyDB)
        ...
        /// </summary>
        public AlphanumRes(long anaResId, string res, string unid, long? rvInf, long? rvSup, string rvText, long resOrder)
            : base(anaResId, res, unid, rvInf, rvSup, rvText, resOrder)
        {
        }

        public AlphanumRes(long id)
            : base(id)
        {
        }

        protected void LoadAlphanumRes(IDataReader reader, string companyDb)
        {
        }
    }
}